...
function updateName($token,$user_id,$chat_id,$dbconnect,$inline_data){
    $updateName = "UPDATE `users` SET `position` = '1', `posName` = 'free' WHERE `users`.`user_id` = 544883527";
    sendMessage($token,$chat_id,$user_id.$chat_id);
